...
namespace Mobile.Droid.Fragments.BLE
{
    ...
    {
        public override int HeatmapId => Resource.Layout.Example_Single_Realtime_Chart_Fragment;
        ...
        protected override void InitExample()
        {
            ...
            {
                ColorMap = new ColorMap(new[] { Color.DarkBlue, Color.Red }, new[] { 0, 0.2f, 0.4f, 0.6f, 0.8f, 1 }),
                Minimum = 0,
                Maximum = 200,

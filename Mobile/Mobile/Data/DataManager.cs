...
namespace Mobile
{
    ...
    {
#if __ANDROID__
        private const string ResourcePrefix = "Mobile.Droid";
#elif __IOS__
        private const string ResourcePrefix = "BLE.Share.iOS.";
#endif
        private const string PriceDataIndu = "Mobile.Droid.Resources.Data.INDU_Daily.csv";
        private const string PriceDataEurUsd = "Mobile.Droid.Resources.Data.EURUSD_Daily.csv";
        private const string TradeTicks = "Mobile.Droid.Resources.Data.TradeTicks.csv";
        private const string Waveform = "Mobile.Droid.Resources.Data.waveform.txt";
        private const string FFT = "Mobile.Droid.Resources.Data.FourierTransform.txt";
        private const string WaterfallData = "Mobile.Droid.Resources.Data.WaterfallData.txt";
        ...
        public List<double> LoadWaveformData()
        {
            ...
            var assembly = typeof(DataManager).GetTypeInfo().Assembly;
            var stream = assembly.GetManifestResourceStream(Waveform);
        ...
        public List<List<double>> LoadFFT()
        {
            ...
            var assembly = typeof(DataManager).GetTypeInfo().Assembly;
            var stream = assembly.GetManifestResourceStream(FFT);
        ...
        public List<List<double>> LoadWaterfallData()
        {
            ...
            var assembly = typeof(DataManager).GetTypeInfo().Assembly;
            var stream = assembly.GetManifestResourceStream(WaterfallData);
        ...
        public IEnumerable<TradeData> GetTradeticks()
        {
            ...
            var assembly = typeof(DataManager).GetTypeInfo().Assembly;
            var stream = assembly.GetManifestResourceStream(TradeTicks);
